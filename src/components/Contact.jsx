    ...
    >
      ...
      <div className=" p-10 flex flex-col gap-10">
        ...
        <div className="flex flex-col items-center py-3">
          <h1 className="text-center text-3xl text-red-500 py-3 text-center">
            SEND ME AN EMAIL
          </h1>
          ...
          <form
            ...
            ref={form}
            className="flex flex-wrap justify-center gap-5 py-9"
          >
            <div className="flex flex-col md:flex-row w-full justify-between gap-5">
              <input
                type="text"
                name="user_name"
                className="w-full md:w-1/2 rounded-xl shadow-lg py-2 px-5 text-black my-1"
                placeholder="Name"
            ...
            <input
              type="text"
              name="subject"
              className="rounded-xl shadow-lg py-2 px-5 text-black basis-[100%] my-1"
              placeholder="Subject"
            />
            <textarea
              name="message"
              ...
              cols="10"
              rows="5"
              className="rounded-xl shadow-lg py-1 px-5 text-black w-full my-1"
            ...
            <button
              className="rounded-lg bg-red-500 py-2 my-2 px-5 text-white  "
              type="submit"
            >
              Send Message
            </button>
